...
class X509 {
    constructor(validator, obj) {
        ...
        this.raw = obj.DER;
        this.version = this.captures.certVersion == null ? 0 : (asn1_1.ASN1.parseIntegerNum(this.captures.certVersion.bytes) + 1);
        this.serialNumber = asn1_1.ASN1.parseIntegerStr(this.captures.certSerialNumber.bytes);
        this.signatureOID = asn1_1.ASN1.parseOID(this.captures.certSignatureOID.bytes);
        this.signatureAlgorithm = common_1.getOIDName(this.signatureOID);
        this.signature = asn1_1.ASN1.parseBitString(this.captures.certSignature.bytes).buf;
        ...
        if (this.captures.certIssuerUniqueId != null) {
            this.issuer.uniqueId = asn1_1.ASN1.parseBitString(this.captures.certIssuerUniqueId.bytes);
        }
        this.extensions = [];
        ...
        try {
            ...
            if (this.captures.certSubjectUniqueId != null) {
                this.subject.uniqueId = asn1_1.ASN1.parseBitString(this.captures.certSubjectUniqueId.bytes);
            }
        }
        catch (e) {
...
class Certificate extends X509 {
    ...
    constructor(obj) {
        ...
        this.infoSignatureOID = asn1_1.ASN1.parseOID(this.captures.certinfoSignatureOID.bytes);
        this.authorityKeyIdentifier = '';
        this.validFrom = asn1_1.ASN1.parseTime(this.captures.certValidityNotBefore.tag, this.captures.certValidityNotBefore.bytes);
        this.validTo = asn1_1.ASN1.parseTime(this.captures.certValidityNotAfter.tag, this.captures.certValidityNotAfter.bytes);
        for (const ext of this.extensions) {
            if (typeof ext.authorityKeyIdentifier === 'string') {
                this.authorityKeyIdentifier = ext.authorityKeyIdentifier;
            }
        }
        this.publicKey = new pki_1.PublicKey(this.captures.publicKeyInfo);
 ...
 * X.509v3 Certificate.
 */
class CertificateSigningRequest extends X509 {
    /**
     * Parse one or more X.509 certificates from PEM formatted buffer.
     * If there is no certificate, it will throw error.
     * @param data PEM formatted buffer
